...
This theme has support for [Tufte-stype margin / side notes](https://edwardtufte.github.io/tufte-css/). The UX of which has been inspired by [pandoc-sidenote](https://github.com/jez/pandoc-sidenote)
