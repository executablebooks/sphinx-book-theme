...
var collapsibleListener=()=>{$(".collapsible-parent>i").on("click",function(){$collapsibleParent=$(this).closest(".collapsible-parent")
if($collapsibleParent.prop("tagName")=="P"){$ul=$collapsibleParent.next("ul")}else{$ul=$collapsibleParent.find("ul")}
$i=$(this)
